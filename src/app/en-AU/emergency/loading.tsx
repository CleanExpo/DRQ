...
export default function EmergencyLoadingPage() {
  return (
    <div className="flex flex-col gap-12 py-8 animate-pulse">
      ...
      <section className="bg-red-600/50 px-4 py-16">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="h-12 bg-gray-200 rounded-lg w-1/2 mx-auto" />
          <div className="h-6 bg-gray-200 rounded w-2/3 mx-auto" />
          <div className="h-10 bg-gray-200 rounded w-1/3 mx-auto mt-8" />
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-red-50 p-4 rounded-lg">
                  <div className="h-6 bg-red-200 rounded w-1/3 mb-2" />
                  <div className="h-4 bg-red-200 rounded w-2/3" />
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <div className="h-6 bg-blue-200 rounded w-1/3 mb-2" />
