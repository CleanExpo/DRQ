...
export default function SewageCleanupError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    // Log the error
    tracking.trackErrorOccurrence('sewage-cleanup-page', error.message);
  }, [error])

  const handleEmergencyCall = () => {
    tracking.trackEmergencyContact('phone', 'sewage-cleanup-error');
  };
    ...
    <div className="container mx-auto px-4 py-12">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-red-600 mb-4">
                ...
                For immediate sewage cleanup assistance, please call our emergency line.
              </p>
      ...
      <div className="max-w-2xl mx-auto mt-8 text-center">
        ...
        <ul className="text-gray-600 space-y-2">
          <li>Emergency Sewage Cleanup</li>
