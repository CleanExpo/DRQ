...
export default function WaterDamageCommercialError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    // Log the error
    tracking.trackErrorOccurrence('water-damage-commercial-page', error.message);
  }, [error])

  const handleEmergencyCall = () => {
    tracking.trackEmergencyContact('phone', 'water-damage-commercial-error');
  };
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-red-600 mb-4">
                ...
                For immediate commercial water damage assistance, please call our priority line.
              </p>
      ...
      <Card className="max-w-2xl mx-auto">
        <CardContent className="p-8 text-center">
          ...
          <h2 className="text-2xl font-bold mb-4">
            Commercial Water Damage Support
          </h2>
